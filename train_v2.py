...
from training import training_loop_v2 as training_loop
...
def setup_training_loop_kwargs(
    ...
    # TODO: args.G_kwargs = dnnlib.EasyDict(class_name='training.networks.Generator', z_dim=512, w_dim=512, mapping_kwargs=dnnlib.EasyDict(), synthesis_kwargs=dnnlib.EasyDict())
    ...
    # TODO: args.G_kwargs.synthesis_kwargs.channel_max = args.D_kwargs.channel_max = 512
...
def main(ctx, outdir, dry_run, **config_kwargs):
    ...
    with open(Path(f"{args.training_set_kwargs.path}/info.txt"), 'r') as f:
        dataset_name = f.read()
